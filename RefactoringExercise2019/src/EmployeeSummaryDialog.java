...
public class EmployeeSummaryDialog extends JDialog implements ActionListener {
	...
	public Container summaryPane() {
		...
		summaryDialog.add(buttonPanel, LayoutType.grow + ", " + LayoutType.push + ", " + LayoutType.wrap);
		summaryDialog.add(scrollPane,LayoutType.grow + ", " + LayoutType.push + ", " + LayoutType.wrap);
